...
if string.find(GetBuildInfo(), "^6%.") then
...
VF_ClassColor = {
	...
	["HUNTER"] = "|cffabd473",
	["PALADIN"] = "|cfff58cba",
	["DH"] = "|cfff58cba", -- Support Legion Core
	["DK"] = "|cfff58cba", -- Support TLK Core
	["MONK"] = "|cfff58cba", -- Support MOP Core
	["PET"] = "|cff00ff00", 
};
...
VF_ClassToIndex = {
	...
	["Hunter"] = 8,
	["Paladin"] = 9,
    ["Demon_hunter"] = 10, --- Support Legion Core
    ["Death"] = 11, --- Support TLK Core
    ["Monk"] = 12, --- Suppor MOP CORE
};
...
VF_RaceToIndex = {
    ...
    ["Bloodelf"] = 8, -- FIXED
    ["Nighelf"] = 9, -- FIXED
    ["Worgen"] = 10, -- Support cata core
    ["Goblin"] = 11, -- Support Cata core
};
...
VF_ZoneToIndex = {
    ...
    -- Zones Cata (Not yet implemented)


    -- Zones MOP (Not yet implemented)



    -- Zones WOD (Not yet implemented)


    -- Zones legion (Not yet implemented)
};
